...
CORS_ORIGIN_WHITELIST = (
    "http://localhost:3000",
    "https://mdhome-front-holf.vercel.app",
)
...
EMAIL_HOST_PASSWORD = 'bkkp hmcn gdxe kdwn'    # Reemplaza con tu contraseña de Gmail

# Opcional: Dirección desde la cual se enviarán los correos
